...
import { buildOwnersMap } from "../../src/lib/shipgen/connectivity";
import { footprintCells, doorEndpoints, key } from "../../src/lib/shipgen/model";
