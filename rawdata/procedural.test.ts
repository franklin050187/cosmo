...
import { checkFunctionalConnectivity, checkCrewConnectivity } from "../../src/lib/shipgen/connectivity";
import { computePowerStats, computeCrewStats } from "../../src/lib/shipgen/power";
