...
description: Diagnosis loop for hard bugs and performance regressions for CosmoShip. Use when the user says diagnose/debug or reports broken/throwing/failing/slow.
---
