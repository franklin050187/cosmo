---
name: unslop
description: Cut AI tells from any writing. Must always apply after every writing task.
---
...
## Always-run rule (CosmoShip)

This skill **must run after every writing task** in this repo (docs, `docs/CODE_AUDIT_*.md`, `docs/AUDIT_ACTIONS_*.md`, `README.md`, `AGENTS.md`, PR descriptions, comments, and any user-facing copy). After producing or editing prose, invoke `skill({ name: "unslop" })` logic in-place: scan the 31 patterns, rewrite, add soul, self-audit, and strip private data before handing back the writeup. Do not skip even for short messages.
