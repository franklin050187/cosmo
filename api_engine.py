...
def extract_tags_v2(png_file):
    ...
    def send_file(base_url, png_file):
        try:
    ...
    with ThreadPoolExecutor() as executor:
        future_to_url = {executor.submit(check_url, url): url for url in [API_URL, API_URL_FALLBACK, API_LOCAL]}
        ...
        for future in as_completed(future_to_url):
            ...
            try:
                ...
                if response and response.status_code == 200:
                    ...
                    file_response = send_file(base_url, png_file)
